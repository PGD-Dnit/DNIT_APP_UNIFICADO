...
import "./SingleTileMapViewer.css";
...
export default function SingleTileMapViewer({
    tileUrl,
    title = "Mosaico Atual",
    mosaics = [],
    initialViewpoint,
    ...
    /** Atualiza URL do tile sem recriar a view */
    useEffect(() => {
    ...
    /** Sincroniza URL externa quando o mosaic selecionado mudar no pai */
    useEffect(() => {
